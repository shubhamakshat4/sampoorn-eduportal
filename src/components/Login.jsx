        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-white/70 backdrop-blur-md p-6">
            <div className="bg-white/80 rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
                <h2 className="text-3xl font-extrabold text-orange-700 mb-4">
                    Placement Track Login
                </h2>

                <p className="text-gray-600 mb-6">
                    🔒 <strong>Note:</strong> This is a demo prototype. You can simply click on the{" "}
                    <span className="font-semibold text-orange-700">Login</span> button to continue.
                </p>
                ...
                <p className="text-sm text-gray-500 mt-4">
                    Powered by <span className="text-orange-700 font-semibold">SSU Faculty of Engineering & Technology</span>
                </p>
            </div>
        </div>
    );
